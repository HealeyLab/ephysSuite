function get_song
    ...
    function save(~, ~)
        ...
        y = y-mean(y);
        plot(y)
        newFolder = fullfile(hs.savePathEdit.String, ['zf son ' hs.subjectEdit.String]);
        mkdir(newFolder);
        audiowrite(fullfile(newFolder, 'BOS.wav'), y, Fs);
    end
    ...
    function open(hObject, ~)
        ...
        hObject.UserData = struct('board_adc', board_adc,...
